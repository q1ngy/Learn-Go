...
const file_hello_proto_rawDesc = "" +
	"\n" +
	"\vhello.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\"\x1e\n" +
	"\bHelloReq\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"!\n" +
	"\tHelloResp\x12\x14\n" +
	"\x05reply\x18\x01 \x01(\tR\x05reply2H\n" +
	"\aGreeter\x12=\n" +
	"\bSayHello\x12\f.pb.HelloReq\x1a\r.pb.HelloResp\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/helloB\x13Z\x11gateway/server/pbb\x06proto3"
